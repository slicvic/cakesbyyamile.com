	...
	<div class="container">
		<div class="page-content">
			...
			<div class="read-moresec">
	    		<a class="error-btn" href="<?php echo esc_url(home_url()); ?>"><?php echo esc_html(get_theme_mod('vw_bakery_404_page_button_text',__('Return to the home page','vw-bakery')));?><span class="screen-reader-text"><?php esc_html_e( 'Return to the home page','vw-bakery' );?></span></a>
	    	</div>
	    </div>
