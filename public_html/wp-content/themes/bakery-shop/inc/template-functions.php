    ...
    echo '<div class="footer-b">';
        echo '<div class="container">'; 
            echo '<div class="site-info">';
                ...
                printf( '&nbsp;%s', '<a href="'. esc_url( __( 'http://prosystheme.com/wordpress-themes/bakery-shop/', 'bakery-shop' ) ) .'" target="_blank">'. esc_html__( '', 'bakery-shop' ) .'</a>' );
                printf( esc_html__( '', 'bakery-shop' ), '<a href="'. esc_url( __( 'https://wordpress.org/', 'bakery-shop' ) ) .'" target="_blank">'. esc_html__( '', 'bakery-shop' ) . '</a>' );
            echo '</div>';
        echo '</div>';
    echo '</div>';
}
