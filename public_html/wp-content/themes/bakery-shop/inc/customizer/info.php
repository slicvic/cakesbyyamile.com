...
function bakery_shop_customizer_theme_info( $wp_customize ) {
	...
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Documentation', 'bakery-shop' ) . ': </label><a href="' . esc_url( 'http://prosystheme.com/documentation/bakery-shop/' ) . '" target="_blank">' . __( 'here', 'bakery-shop' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Demo', 'bakery-shop' ) . ': </label><a href="' . esc_url( 'http://prosystheme.com/preview/bakery-shop/' ) . '" target="_blank">' . __( 'here', 'bakery-shop' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Support Forum', 'bakery-shop' ) . ': </label><a href="' . esc_url( 'http://prosystheme.com/support-forum/' ) . '" target="_blank">' . __( 'here', 'bakery-shop' ) . '</a></span><br />';
	...
	$manager->add_section(
		new Bakery_Shop_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => 'http://prosystheme.com/wordpress-themes/bakery-shop-pro/'
			)
		)
	);
}