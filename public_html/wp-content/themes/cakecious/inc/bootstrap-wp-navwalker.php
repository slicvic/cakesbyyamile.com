<?php
/**
 * Adapted from Edward McIntyre's Cakecious_WP_Bootstrap_Navwalker class.
...
/**
 * Class Cakecious_WP_Bootstrap_Navwalker
 ...
 */
class Cakecious_WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
	/**
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			*/
			if ( $args->has_children && $depth === 0 ) {
				...
				$class_names .= ' dropdown-submenu dropdown submenu';
			}
			...
			if ( $args->has_children && $depth === 0 ) {
				...
				$atts['class']       = 'nav-link1 dropdown-toggle';
			} else {
				$atts['href']  = ! empty( $item->url ) ? $item->url : '';
				$atts['class'] = 'nav-link1';
			}
