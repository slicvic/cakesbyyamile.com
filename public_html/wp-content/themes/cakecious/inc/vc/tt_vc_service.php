...
function tt_vc_service_fn_vc() {
    vc_map(
        array(
			...
			"icon"     => 'tt-vc-block',
            'description'             => esc_html__( 'Service block for this theme.', 'cakecious' ),
			...
			"params" => array(
				...
				array(
					...
					'description' => esc_html__( 'Type 2 is used on homepage 4.', 'cakecious' ),
					"param_name" => "type",
					"value" => array(
						'Default' => 'default',
						'Type 2' => 'type2',
				...
				array(
					"type" => "dropdown",
					"heading" => esc_html__("Background Style.", 'cakecious'),
					"param_name" => "bgtype",
					"value" => array(
						'Default' => 'bg-dark',
						'Dark'    => 'bg-light',
